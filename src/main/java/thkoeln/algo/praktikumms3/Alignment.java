 ...
 *    |   _   |  |__|.-----.-----.--------.-----.-----.|  |_
 *    |       |  |  ||  _  |     |        |  -__|     ||   _|
 *    |___|___|__|__||___  |__|__|__|__|__|_____|__|__||____|
 *                   |_____|
 *
...
public class Alignment {
    ...
    public String toString() {
        ...
        sb.append("Sequence X: ").append(this.getX_Sequence()).append('\n');
        sb.append("Sequence Y: ").append(this.getY_Sequence()).append('\n');
        sb.append("Resultstring X: ").append(this.getX_Alignment()).append('\n');
        sb.append("   Operations : ").append(this.getOperationsString()).append('\n');
        sb.append("Resultstring Y: ").append(this.getY_Alignment()).append('\n');
        sb.append("         Score: ").append(this.getScore()).append('\n');

        sb.append('\n');
        sb.append("ScoreMatrix:\n");
        if (getScoreMatrix() != null)
            sb.append(MatrixUtil.printScoreMatrix(scoreMatrix));
        sb.append('\n');
        sb.append("AlignmentTable:\n");
        if (getScoreMatrix() != null)
            sb.append(MatrixUtil.printAlignmentTableColorsExperimental(
                    this.getX_Sequence(),
                    this.getY_Sequence(),
                    this.getScoreMatrix()));
